                            ...
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    ...
                                    <tr class="active">
                                        ...
                                        <td>{{\Carbon\Carbon::parse($jobApplication->applied_date)->format('d M,
                                            Y')}}</td>
                                            ...
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item"
                                                            href="{{route('jobDetail',$jobApplication->id)}}"> <i
                                                                class="fa fa-eye" aria-hidden="true"></i> View</a></li>
                                                    <li><a class="dropdown-item"
                                                            onclick="removeJob({{$jobApplication->id}})" href="#"><i
        ...
        if(confirm('Are you sure you want to Remove Job?')){
            $.ajax({
                ...
                success: function (response) {
                    window.location.href="{{route('account.myJobsApplication')}}";
                }
            });
         }
    }
