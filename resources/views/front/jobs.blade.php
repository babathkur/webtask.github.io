    ...
    <div class="container">
        ...
        <div class="row pt-5">
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                ...
                <form action="" id="searchForms" name="searchForms">
                    <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Keywords</h2>
                            <input value="{{Request::get('keyword')}}" type="text" name="keywords" id="keywords"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                                ...
                                name="job_type" type="checkbox" value="{{$jobType->id}}"
                                id="job_type-{{$jobType->id}}" >
                                <label class="form-check-label "
                                    for="job_type-{{$jobType->id}}">{{$jobType->name}}</label>
                            </div>
