...
class AccountController extends Controller
{
    ...
    public function updateProfilePic(Request $request)
    {
        ...
        if ($validate->passes()) {
            ...
            $source_path = public_path('/profile_pic/' . $image_name);
            $manager = new ImageManager(Driver::class);
            $image = $manager->read($source_path);

            // crop the best fitting 5:3 (600x360) ratio and resize to 600x360 pixel
            $image->cover(150, 150);
            $image->toJpeg()->save(public_path('/profile_pic/thumb/' . $image_name));
    ...
    public function saveJob(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $job->responsibilty = $request->responsibility;
    ...
    public function deleteJob(Request $request)
    {
        ...
        if ($job == null) {
            session()->flash('error', 'Either job Delted or Not Found');
            return response()->json([
                'status' => true,
